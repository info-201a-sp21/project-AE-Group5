...
intro_sidebar_content <- sidebarPanel(
  ...
  p("To cope with this problem, Paris Aggrement was signed by
    nations to maintain the temperature well under 2.0 Celsius (3.6 Fahrenheit)
    in 2015.However, the temperature is sitll higher than this value now."),
...
map_main_content <- mainPanel(
  ...
  change by comparing countries in different years. Through this map,
  we can have a better idea of climate trends
  in 50 years from 1963-2013."),
  plotlyOutput("map"),
  h5("Insights:"),
...
barplot_main_content <- mainPanel(
  ...
  globally as well as in different countries in the wolrd, and it is
  divided into 10 year periods to deal with the volatility of changes.
  The trend of deforestation is varied in different countries,
  but the world's data demonstrates that the amount of forest loss is
  decreasing over the years."),
  plotlyOutput("barPlot"),
  h5("Insights:"),
  h6("- The amount of deforestation is decreasing globally."),
  h6("- Bigger countries with higher populations have a greater
...
summary_page <- tabPanel(
  ...
  hr(),
  p("Through this scatterplot, the trend of fossil fuel combustion
  spending is general global increasing among years.
  China and the United States are the two countries increasing
  fossil fuel combustion spending from 1965 to 2019.Besides, China has three
  times more spending increase than the United States.Interestingly,
  United States' fossil fuel combustion spending the highest year in 2000,
  and it starts to decrease slightly, while China's fossil fuel combustion
  spending start dramatically increasing after 2000. By discovering
    the data from this page, it helps us gain insight that the burning fossil
    still is used in many countries, and the idea of eco-friendly 
    lack of supported."),
  br(),
  ...
  the United States average temperature in 1964 was -3.196 Celsius,
  -2.155 in 2013.
    ...
    change in countries or global, climate change trend is harmful
    to the environment, and we predict that the fossil fuel combustion
    spending can be one of the factors that
    cause surface temperature increase."),
  br(),
  ...
  The amount of forest loss has reduced by about 5 to 6 million trees over
  two decades.The world's data for deforestation was at about
  15-16 million in 1990 and it decreases to 10-11 million in 2020.
  Big countries such as China, Mexico and Canada are reducing the
  deforesation levels but to varying degrees. Some countries like China
  decreased at lower level than countries like Canada. Through the bar plot,
  we learned that deforestation is still occuring in many countries,
  but overall it has decreased worldwide.
  Knowing this information helps us to analyze the amount of
  deforestation in each country and how different countries contribute
